package com.shukhaev.mytasks.adapters
...
import com.shukhaev.mytasks.databinding.ItemListTasksBinding
...
class TaskAdapter (private val listener: OnItemClickListener): ListAdapter<Task, TaskAdapter.TaskViewHolder>(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TaskViewHolder {
        val binding =
            ItemListTasksBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class TaskViewHolder(private val binding: ItemListTasksBinding) :
